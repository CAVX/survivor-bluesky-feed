...
export class FeedHandler implements TimerHandler {
  ...
  filterPost(postText) {
    ...
    const excludeHashtagsRegex = /#survivorseries|#survivorgameplay|#deadbydaylight|#survivors|#survivorslike|#rainworld|#survivorlike|#survivorsguilt|#survivorguilt|#csasurvivor|#survivorsempowered|#mentalhealth|#excult|#traffickingsurvivor|#survivorcoach|#survivormusic|#survivorchoir|#abortion|#csa|#sa|#cptsd|#iptv/i;
